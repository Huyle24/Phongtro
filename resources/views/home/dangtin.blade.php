...
<div class=" container container-body">
	<div class="row">
		<div class="col-md-8">
			<h1 style="margin-top: 20px; margin:center">ĐĂNG TIN PHÒNG TRỌ</h1>
			<hr>
			<div class="panel panel-default">
				<div class="panel-heading">Các thông tin bắt buộc*</div>
          ...
          @if(Auth::user()->tinhtrang != 0)
            ...
            <button class="btn btn-primaryy">Đăng Tin</button>
          </form>
          @else
          <div class="alert bg-danger">
            <button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
     ...
     <div class="contactpanel">
      <div class="row" style="margin-top: 30px;">
        <div class="col-md-4 text-center">
              ...
              @else
                <img src="uploads/avatars/<?php echo Auth::user()->avatar; ?>" class="img-circle" alt="Cinque Terre" width="100" height="100"> 
              @endif
        </div>
      <div class="col-md-8">
