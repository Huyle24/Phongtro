...
@section('content')
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="pull-right"> <b>Lượt xem:</b> {{ $motelroom->count_view }} - <span> <b>Ngày đăng: </b>
                            </span>
            ...
            <div class="col-md-4">
                        ...
                        <div class="col-md-4 text-center">
                            @if ($motelroom->user->avatar == 'no-avatar.jpg')
                                <img src="images/no-avatar.jpg" class="img-circle" alt="Cinque Terre" width="100"
                                    height="100">
                            @else
                                <img src="uploads/avatars/<?php echo $motelroom->user->avatar; ?>" class="img-circle" alt="Cinque Terre"
                ...
                @else
                    <div class="detail" style="margin-top: 30px;">
                        ...
                        <p>
                            <span class="price_area"><i class="far fa-money-bill-alt"></i><?php echo number_format($motelroom->price); ?> <span
                                    class="price_label" style="margin-right:20%">VND</span></span>
                            <strong><i class="fas fa-street-view"></i> Diện tích: </strong><span> {{ $motelroom->area }} m
                                <sup>2</sup> </span>
                        </p>
                        <!-- Tiện ích -->
                            ...
                            <div style="padding: 5px;">
                                <div class="row-12">
                                    @foreach ($arrtienich as $tienich)
                                        <span class="col-6"style="width:50%"><i class="fas fa-check"></i> {{ $tienich }}</span>
                                    @endforeach
                                </div>
                            </div>
                        </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCzlVX517mZWArHv4Dt3_JVG0aPmbSE5mE&callback=initMap" async
        defer></script>
@endsection
