...
@section('content')
    ...
    <div class="">
        <div class="banner" style="">
            ...
            <div id="slider-container">
                <img width="100%" height="750px" src="../images/banner.jpg">
                <img width="100%" height="750px" src="../images/banner1.avif">
                {{-- <img width="100%" height="720px" src="../images/banner2.jpg"> --}}
                <img width="100%" height="750px" src="../images/banner3.jpg">
                <img width="100%" height="750px" src="../images/banner4.jpg">
                <div class="spots">
                    <span class="spot" data-index="0"></span>
                    <span class="spot" data-index="1"></span>
                    {{-- <span class="spot" data-index="2"></span> --}}
                    <span class="spot" data-index="3"></span>
                    <span class="spot" data-index="4"></span>
                </div>
                <!-- Thêm số lượng spot tương ứng với số lượng ảnh trong slider -->
                        ...
                        <div class="col-xs-3">
                            <select class="selectpicker" data-live-search="true" id="selectcategory">
                                @foreach ($categories as $category)
                                    <option data-tokens="{{ $category->slug }}" value="{{ $category->id }}">
                            ...
                            <div class="col-md-8">
                                <div class="room-detail">
                                    ...
                                    <div class="room-info">
                                        ...
                                        <div class="address"><i class="fas fa-map-marker"></i> Địa chỉ:
                                            {{ $room->address }}</div>
                                        <div style="color: #e74c3c"><i class="far fa-money-bill-alt"></i> Giá thuê:
                                            <b>{{ number_format($room->price) }}</b>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <h3 class="title-comm"><span class="title-holder">PHÒNG TRỌ MỚI ĐĂNG </span></h3>
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="room-detail">
                                        <h4><a href="phongtro/{{ $room->slug }}">{{ $room->title }}</a></h4>
                                        <div class="room-meta">
                                            <span><i class="fas fa-user-circle"></i> Người đăng:
                                                {{ $room->user->name }}</span>
    ...
    <script>
        ...
        // Add event listeners to the spots
        spots.forEach((spot, index) => {
            spot.addEventListener("click", () => changeImage(index));
        });
    </script>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDej-CHRaTCF5vaK9vkd8vty8Eo2Vv2Ids&callback=initMap" async
        defer></script>
@endsection
<style>
    .box-search {
